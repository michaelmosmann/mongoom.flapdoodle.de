...
public class QueryResult<T> implements IQueryResult<T> {
	...
	public QueryResult(IEntityConverter<?> entityConverter, IReadConverter<T> converter, DBCollection dbCollection,
			DBObject query, DBObject view) {
		_entityConverter = entityConverter;
		_converter = converter != null
				? converter
				: (IReadConverter<T>) entityConverter;
	...
	public IQueryResult<T> order(String field, boolean asc) {
		if (_entityConverter.converter(field) == null)
